        <header role="banner">
            <div class="logo-wrapper">
                <svg version="1.1" id="logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 668 222" preserveAspectRatio="xMinYMin meet" style="enable-background:new 0 0 668 222;" aria-labelledby="header-logo-title" xml:space="preserve" >
                    Emory Libraries
        ...
        <header class="introduction">
            <h1>Search for the Director of the Stuart A. Rose Manuscript, Archives, and Rare Book Library</h1>
            <p>Emory Libraries has initiated a search for the next Director of the <a href="http://rose.library.emory.edu">Stuart A. Rose Manuscript, Archives, and Rare Book Library</a>. Relevant information can be found below.</p>
        </header>
